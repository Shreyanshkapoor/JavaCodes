...
public class TicTacToe implements ActionListener {
    ...
    TicTacToe() {
        ...
        titlePanel.add(restartButton, BorderLayout.EAST); // Add restart button to titlePanel
    ...
    private void restartGame() {
        // Reset gameEnded and player1Turn
        gameEnded = false;
        player1Turn = true;
        ...
        for (int i = 0; i < 9; i++) {
            ...
            buttons[i].setForeground(Color.BLACK); // Reset button color
        }
